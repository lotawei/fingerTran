...
@interface AllGoodsViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,CellProtocol,ShowViewDelegate,UIScrollViewDelegate>
...
-(void)viewDidLoad
{
    ...
    //注册上拉刷新功能
    __weak AllGoodsViewController *weakSelf = self;
...
-(void)scrollViewWillEndDragging:(UIScrollView *)scrollView withVelocity:(CGPoint)velocity targetContentOffset:(inout CGPoint *)targetContentOffset{    if (scrollView.contentOffset.y<-64) {
