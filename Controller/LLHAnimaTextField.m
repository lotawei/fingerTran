...
@interface LLHAnimaTextField ()<UITextFieldDelegate>
{
    CGFloat   _percent;
}
...
@implementation LLHAnimaTextField
...
- (void)setup {
    ...
    self.placeHolderHighlightColor = [UIColor blueColor];
...
- (UILabel *)placeHolderL {
    if (!_placeHolderL) {
        ...
        _placeHolderL.highlightedTextColor = [UIColor blueColor];
    }
