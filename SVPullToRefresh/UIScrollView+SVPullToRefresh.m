...
//                                            constrainedToSize:CGSizeMake(labelMaxWidth,self.titleLabel.font.lineHeight)
        CGSize size = CGSizeMake(labelMaxWidth,2000);
        NSDictionary *attribute = @{NSFontAttributeName: self.titleLabel.font};
//                                                lineBreakMode:self.titleLabel.lineBreakMode];
        CGSize titleSize  =[self.titleLabel.text  boundingRectWithSize:size options: NSStringDrawingTruncatesLastVisibleLine| NSStringDrawingUsesLineFragmentOrigin |NSStringDrawingUsesFontLeading attributes:attribute context:nil].size;
        
        
        CGSize subtitleSize = [self.subtitleLabel.text boundingRectWithSize:size options: NSStringDrawingTruncatesLastVisibleLine| NSStringDrawingUsesLineFragmentOrigin |NSStringDrawingUsesFontLeading attributes:attribute context:nil].size;
