...
-(void)setSlideHeadView{
    ...
    self.titleScrollView.backgroundColor = [UIColor colorWithRed:0.0f green:0.1f blue:0.5f alpha:1];
}
...
-(void)setupTitle{
    ...
    CGFloat w = 130;
    CGFloat h = titleH;
    self.imageBackView  = [[UIImageView alloc] initWithFrame:CGRectMake(30, 5, 80-10, titleH-10)];
...
-(void)selectTitleBtn:(UIButton *)btn{
    ...
    [btn setTitleColor:[UIColor colorWithRed:0.2f green:0.55f blue:1.0f alpha:1] forState:UIControlStateNormal];
...
//    UIColor *leftColor = [UIColor colorWithRed:(174+66*scaleL)/255.0 green:(174-71*scaleL)/255.0 blue:(174-174*scaleL)/255.0 alpha:1];
    ...
    UIColor *rightColor = [UIColor colorWithRed:0.2f green:0.55f blue:1.0f alpha:1];
    UIColor *leftColor = [UIColor colorWithRed:0.2f green:0.55f blue:1.0f alpha:1];
